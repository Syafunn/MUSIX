...
<html lang="en">
  ...
  <body>
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://billboardphilippines.com/wp-content/uploads/2024/05/Laufey-Feature-Article-FTR-IMG-1600x838.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://media.philstar.com/photos/2023/02/24/lyn_2023-02-24_19-50-36.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://cdn.idntimes.com/content-images/community/2018/12/27575939-117544975728018-1401623986768445440-n-9926cfc346b313bf8d0142c560200f87_600x400.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://popspoken.com/wp-content/uploads/2020/09/beabadoobee-jordan-curtis-hughes2-8eb56be1a64ebccc6b704fa65166f7a38989394d-s1600-c85-1-850x560.jpg" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
    ...
    <section id="aboutme" class="text-center p-5 bg-primary-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="https://nchschant.com/wp-content/uploads/2023/10/Laufey-Cover-Photo.jpg"
    ...
    <footer id="footer" class="text-center p-5" style="background-color: #FFAFCC">
      <div>
        <a href="https://www.instagram.com/syafunn/"
          ><i class="bi bi-instagram h2 p-2 text-secondary"></i
        ></a>
        <a href="https://www.youtube.com/@syafunn1316"
          ><i class="bi bi-youtube h2 p-2 text-secondary"></i
        ></a>
        <a href="https://wa.me/6281329336654"
          ><i class="bi bi-whatsapp h2 p-2 text-secondary"></i
        ></a>
      </div>
      <div class="text-secondary">Syafan Midhad &copy; 2023 
      </div>
    </footer>
    <!-- footer end -->
